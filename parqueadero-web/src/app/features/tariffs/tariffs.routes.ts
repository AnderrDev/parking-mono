...
import { TariffLocalDataSource } from './data/datasources/tariff-local.datasource';
...
const tariffProviders = [
  ...
  { provide: TARIFF_LOCAL_DATASOURCE_TOKEN, useClass: TariffLocalDataSource },
