...
const cashierProviders = [
  ...
  { provide: CORRECT_PAYMENT_AMOUNT_TOKEN, useClass: CorrectPaymentAmountUseCase },
...
export const cashierRoutes: Routes = [
  ...
  },
  {
    ...
    loadComponent: () =>
      import('./presentation/pages/shift-history.page').then(
        (m) => m.ShiftHistoryPageComponent,
      ),
    data: { title: 'Historial de turnos' },
  },
];
